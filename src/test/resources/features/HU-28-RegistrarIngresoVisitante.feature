Feature: Registrar el ingreso de un visitante
  Como usuario Quiero Registrar el ingreso de un visitante Para realizar su seguimiento
  ...
  Scenario: Información que se presenta al seleccionar el botón de Registro
  ...
  Scenario Outline: Se habilita si o no botón de guardar
    When <Ingresa> toda la informacion en los campos requeridos en registro visitante
  ...
  Scenario Outline: Ingresar información en campos obligatorios
    When Ingresa en registro visitante en el campo <campo_requerido> la informacion <informacion>
    Then Visualiza en registro visitante el resultado esperado <resultado>
    Examples:
  ...
  Scenario: Registro exitoso de ingreso de visitante
