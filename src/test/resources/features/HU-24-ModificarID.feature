Feature: Modificar ID de tarjeta de Ingreso
  Como usuario Quiero modificar un ID de Tarjeta de Ingreso Para asignar a un usuario.
  ...
  Scenario: Información que se presenta al seleccionar el botón de Modificar ID
  ...
  Scenario Outline: Salir del formulario de Modificación de ID
  ...
  Scenario Outline: No ingresar información en los campos requeridos
    When En Modificar ID Da clic en el <campo_requerido>
